...
Original file is located at
    https://colab.research.google.com/drive/15glE6QSBR7kT_qvt5mPc7zGPfUB_kuSb
"""
...
def predict():
    ...
    consumerKey= client.access_secret_version(name=f"projects/twitter-sentiment-rdnwcv/secrets/CKey/versions/latest").payload.data.decode("UTF-8")
    consumerSecret= client.access_secret_version(name=f"projects/twitter-sentiment-rdnwcv/secrets/CSecret/versions/latest").payload.data.decode("UTF-8")
    accessToken= client.access_secret_version(name=f"projects/twitter-sentiment-rdnwcv/secrets/AToken/versions/latest").payload.data.decode("UTF-8")
    accessTokenSecret= client.access_secret_version(name=f"projects/twitter-sentiment-rdnwcv/secrets/ASecret/versions/latest").payload.data.decode("UTF-8")
